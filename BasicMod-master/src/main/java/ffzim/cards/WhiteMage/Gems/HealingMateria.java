...
public class HealingMateria extends BaseCard implements MultiUpgradeCard, OnObtainCard
{
    ...
    public HealingMateria() {this(true);}
    public HealingMateria(boolean makePreview) {
...
//        }
    ...
    public AbstractCard makeCopy() { //Optional
        BaseCard copy = new HealingMateria();
