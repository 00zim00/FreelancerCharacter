...
public class Draw extends BaseCard {
    ...
    public void atTurnStart() {
        setMagic(0);
        setSecondMagic(4);
        cardsToPreview = new Undraw(false,Math.max((this.baseSecondMagicNumber) - 1, 0));
    ...
    public Draw(boolean makePreview, int baseSecondMagicNumber) {
        super(cardInfo, true);
        if (makePreview) {
