...
//
//
//public abstract class BaseCard2 extends CustomCard {
...
//    }
//
//    public BaseCard2(String baseID, int cost, CardType cardType, CardTarget target, CardRarity rarity, CardColor color)
//    {
...
//    }
//
//    public BaseCard2(String cardName, int cost, CardType cardType, CardTarget target, CardRarity rarity, CardColor color, boolean upgradesDescription)
//    {
...
//
//        if (card instanceof BaseCard2)
//        {
//            card.rawDescription = this.rawDescription;
//            ((BaseCard2) card).upgradesDescription = this.upgradesDescription;
//
//            ((BaseCard2) card).baseCost = this.baseCost;
//
//            ((BaseCard2) card).upgradeCost = this.upgradeCost;
//            ((BaseCard2) card).upgradeDamage = this.upgradeDamage;
//            ((BaseCard2) card).upgradeBlock = this.upgradeBlock;
//            ((BaseCard2) card).upgradeMagic = this.upgradeMagic;
//
//            ((BaseCard2) card).costUpgrade = this.costUpgrade;
//            ((BaseCard2) card).damageUpgrade = this.damageUpgrade;
//            ((BaseCard2) card).blockUpgrade = this.blockUpgrade;
//            ((BaseCard2) card).magicUpgrade = this.magicUpgrade;
//
//            ((BaseCard2) card).baseExhaust = this.baseExhaust;
//            ((BaseCard2) card).upgExhaust = this.upgExhaust;
//            ((BaseCard2) card).baseEthereal = this.baseEthereal;
//            ((BaseCard2) card).upgEthereal = this.upgEthereal;
//            ((BaseCard2) card).baseInnate = this.baseInnate;
//            ((BaseCard2) card).upgInnate = this.upgInnate;
//            ((BaseCard2) card).baseRetain = this.baseRetain;
//            ((BaseCard2) card).upgRetain = this.upgRetain;
//        }
//
//        return card;
//    }
