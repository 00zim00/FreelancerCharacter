...
import ffzim.cards.Basics.CombatCommand;
import ffzim.cards.Basics.Defend_FF;
import ffzim.cards.Basics.Strike_FF;
import ffzim.cards.Generic.startercards.ItemCommand;
import ffzim.cards.Generic.startercards.RowCommand;

import java.util.ArrayList;

import static ffzim.BasicMod.characterPath;
import static ffzim.BasicMod.makeID;

public class Freelancer extends CustomPlayer {
    //Stats
    ...
    public static boolean saveableBasic;

    //Strings
    private static final String ID = makeID("Freelancer"); //This should match whatever you have in the CharacterStrings.json file
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    private static final String[] NAMES = characterStrings.NAMES;
    private static final String[] TEXT = characterStrings.TEXT;

//    public void increasePowerPlus(int amount) {
//        powerPlusSavable.get(this);
//        int newValue = PowerPlusSavable.getPowerPlusValue(player) += amount;
//        powerPlusSavable.get(this).setPowerPlusValue(newValue);
//    }
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass FREELANCER;
        @SpireEnum(name = "CHARACTER_GRAY_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor FFcardColor;
        @SpireEnum(name = "CHARACTER_GRAY_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    // Example method to increase the PowerPlus value.


    public Freelancer() {
        super(NAMES[0], Enums.FREELANCER,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Strike_FF.ID);
        retVal.add(Strike_FF.ID);
        retVal.add(Strike_FF.ID);
        retVal.add(Defend_FF.ID);
        retVal.add(Defend_FF.ID);
        retVal.add(Defend_FF.ID);
        retVal.add(CombatCommand.ID);
        retVal.add(ItemCommand.ID);
        retVal.add(RowCommand.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(ffzim.relics.Freelancer.ID);
