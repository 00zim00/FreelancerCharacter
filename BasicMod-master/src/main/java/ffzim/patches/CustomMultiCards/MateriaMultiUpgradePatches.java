...
//
//public class MateriaMultiUpgradePatches {
//
...
//            AbstractCard c = MateriaBranchingUpgradesPatch.getHoveredCard();
...
//            AbstractCard hovered = MateriaBranchingUpgradesPatch.getHoveredCard();
...
//            AbstractCard hoveredCard = MateriaBranchingUpgradesPatch.getHoveredCard();
...
//            AbstractCard card = MateriaBranchingUpgradesPatch.getHoveredCard();
...
//                        count++;
//                        m.replace("if ("+ MateriaMultiUpgradePatches.HideGhostCard.class.getName()+".renderTheCard()) {$_ = $proceed($$);}");
//                    }
//                }
//            };
//        }
...
//            if (AbstractDungeon.screen == AbstractDungeon.CurrentScreen.GRID && AbstractDungeon.gridSelectScreen.forUpgrade && AbstractDungeon.gridSelectScreen.confirmScreenUp && MateriaBranchingUpgradesPatch.getHoveredCard() instanceof MultiUpgradeCard) {
//                return false;
//            }
//            return true;
//        }
