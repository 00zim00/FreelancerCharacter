...
//
//public abstract class RevolvingWorkingBU extends BaseCard {
//
...
////    }
//    public RevolvingWorkingBU(CardInfo cardInfo, boolean upgradesDescription) {
...
//            if (revolvingCount > 0) {
//                RevolvingWorkingBU cardToAdd = (RevolvingWorkingBU) CardLibrary.getCard(cardID).makeStatEquivalentCopy();
...
//
//        if (card instanceof RevolvingWorkingBU)
//        {
//            ((RevolvingWorkingBU) card).revolvingCount = this.revolvingCount;
//            ((RevolvingWorkingBU) card).baseRevolving = this.baseRevolving;
//            ((RevolvingWorkingBU) card).upgRevolving = this.upgRevolving;
//            ((RevolvingWorkingBU) card).cardToAddRevolvingCount = this.cardToAddRevolvingCount;
//            //((Revolving) card).makeRevolingPreview = false;
//
//            if (this.baseRevolving ^ this.upgRevolving) {
//                ((RevolvingWorkingBU) card).selfRevolving = this.upgRevolving;
//            }
//
//        }
//
