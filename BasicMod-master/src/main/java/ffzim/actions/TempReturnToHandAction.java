...
public class TempReturnToHandAction extends AbstractGameAction {
    private static final float DUR = 0.25F;
    private int newStackAmount;
    private int stackAmount;
    private boolean firstApply = true;

    public TempReturnToHandAction(AbstractCreature target, AbstractCreature source, int amount, int stackAmount) {
        this.target = target;
        this.source = source;
        this.amount = amount;
